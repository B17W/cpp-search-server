...
public:
    ...
    vector<Document> FindTopDocuments(const string &raw_query, DocumentStatus s) const
    {
        return FindTopDocuments(raw_query, [s](int document_id, DocumentStatus status, int rating)
                                { return status == s; });
    }
